    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <nav class="flex items-center mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><i class="fas fa-chevron-right text-gray-400"></i></li>
                <li class="text-gray-500">Thêm mới</li>
            </ol>
        </nav>

        <div class="bg-white rounded-xl shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-6"><i class="fas fa-plus text-blue-600 mr-2"></i>Thêm sản phẩm
                mới</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="graphics" id="graphics" value="{{ old('graphics') }}"
                                class="mt-1 w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('graphics')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="battery" id="battery" value="{{ old('battery') }}"
                                class="mt-1 w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('battery')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
