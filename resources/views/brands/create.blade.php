...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-6"><i class="fas fa-plus text-blue-600 mr-2"></i>Thêm thương hiệu
                mới</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div id="image-preview" class="mt-2 hidden">
                            <img id="preview-img" src="#" alt="Image Preview" class="h-24 w-auto rounded">
                        </div>
                        @error('image')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
